  ...
  return (
    ...
    >
      <img
        ...
        decoding="async"
        className={cn(
          "aspect-[4/3] h-20 w-32 rounded-[1.25rem] object-cover shadow-[0_18px_45px_rgba(15,23,42,0.12)] ring-1 ring-black/10 sm:h-40 sm:w-56 md:h-52 md:w-80 dark:ring-white/10",
          imageClassName,
        )}
      />
    </motion.div>
